...
export function Materiais() {
  return (
    <section id="materiais" className="mx-auto max-w-6xl scroll-mt-24 px-5 py-16">
      <SectionTitle
        eyebrow="Orçamento"
      ...
      <div className="mt-10 overflow-hidden rounded-2xl border border-border bg-card">
        <div className="overflow-x-auto">
          <table className="w-full min-w-[560px] text-left text-sm">
            ...
            <tbody>
              {materiais.map((m) => (
                <tr key={m.componente} className="border-b border-border/60 last:border-0">
            ...
            <tfoot>
              <tr className="bg-primary/10">
                <td colSpan={3} className="px-5 py-4 font-display text-base font-bold uppercase tracking-widest text-primary">
                  Total estimado
                </td>
